...
<launch>
    ...
    <arg name="map" default="nav.yaml" />
    <!-- 运行地图服务器，并且加载设置的地图-->
    <node name="map_server" pkg="map_server" type="map_server" args="$(find myCarV8)/map/$(arg map)"/>
    <!-- 启动AMCL节点 -->
    <include file="$(find myCarV8)/launch/amcl.launch" />
    <!-- 运行rviz -->
    <node
...
###### 4.2.4base_local_planner_params.yaml
...
> 首先订阅/move_base_simple/goal话题，然后在rviz中使用粉色箭头指定目标定和位姿，之后从订阅的话题中提取目标点位置和机器人位姿，进行发布
...
def publish_once():
    ...
    pose_msg.pose.position.x = 3.72777700424
    pose_msg.pose.position.y = -3.8072104454
    pose_msg.pose.position.z = 0.0

    pose_msg.pose.orientation.x = 0.0
    pose_msg.pose.orientation.y = 0.0
    pose_msg.pose.orientation.z = -0.337469336367
    pose_msg.pose.orientation.w = 0.94133652166

    rospy.loginfo("Publishing PoseStamped message once: %s", pose_msg)
